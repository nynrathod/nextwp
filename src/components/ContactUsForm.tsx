...
export default function ContactUsForm() {
    ...
    const wasSentMail = Boolean(data);
        ...
        <>
            ...
            <div className="2xl:container h-screen m-auto">
                <div className="relative h-full m-auto">
                    <div className="m-auto py-12 px-6 sm:p-20 xl:w-9/12">
                        ...
                        <form method="post" onSubmit={handleSubmit} className="signup-form space-y-6 py-6">
                            <div className=" mx-auto">
                                <div className="flex flex-wrap -m-2">
                                    ...
                                    <div className="p-2 w-1/2">
                                        <div className="relative">
                                            <select id="country" name="country" className="w-full py-3 px-6 ring-1 ring-gray-300 focus:outline-none focus:ring-gray-900 rounded-lg placeholder-gray-600 bg-transparent transition disabled:ring-gray-200 disabled:bg-gray-100 disabled:placeholder-gray-400 focus:invalid:ring-red-400 focus:invalid:outline-none">
                                    ...
                                    <div className="p-2 w-full">
                                        <textarea
                                            ...
                                            className="w-full py-3 px-6 ring-1 ring-gray-300 focus:outline-none focus:ring-gray-900 rounded-lg placeholder-gray-600 bg-transparent transition disabled:ring-gray-200 disabled:bg-gray-100 disabled:placeholder-gray-400 focus:invalid:ring-red-400 focus:invalid:outline-none h-32"
                                        ></textarea>
                                    </div>
                                </div>
                            </div>
