...
export default function ProfileForm() {
    ...
    (wasProfileUpdated ?
        toast.success('Profile Updated Successfully', { toastId: 'restpass', autoClose: 5000 })
        : ''
    )

    return (
        <>
            {wasProfileUpdated ? <ToastContainer /> : ''}
                ...
                <div className="relative h-full m-auto lg:w-6/12">
                    <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
                        <div className="space-y-6">
                            ...
                            <p className="font-medium text-lg text-gray-700 text-center py-3">Welcome to Vercel | Update profile</p>
                        </div>
                        <form method="post" onSubmit={handleSubmit} className="update-form space-y-6 py-6">
                            <div>
                                <input
                                    type="text"
                                    name="firstName"
